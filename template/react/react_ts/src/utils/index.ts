 ...
 * @returns {Array}
 */
export function getFlatMenuList(menuList: ItemType[]): ItemType[] {
  const newMenuList: ItemType[] = JSON.parse(JSON.stringify(menuList))
 ...
 * @returns {Array}
 * */
export function getShowMenuList(menuList: ItemType[]): ItemType[] {
  const newMenuList: ItemType[] = JSON.parse(JSON.stringify(menuList))
